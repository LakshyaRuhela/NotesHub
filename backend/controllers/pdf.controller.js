...
export const pdfDownload = async (req, res) => {
  ...
  // Sub Topics
  doc.fontSize(18).text("Sub Topics");
  doc.moveDown(0.5);
  Object.entries(result.subTopics).forEach(([star, topics]) => {
    doc.moveDown(0.5);
    doc.fontSize(16).text(`${star} Topics:`);
  ...
  // Revision Points
  doc.fontSize(18).text("Revision Points");
  doc.moveDown(0.5);
  ...
  // Questions
  doc.fontSize(18).text("Important Questions");
  doc.moveDown(0.5);
  ...
  doc.moveDown(0.5);
  doc.fontSize(18).text("Diagram Question:");
